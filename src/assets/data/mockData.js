...
export const mockData = {
  aprovacao: [
    {
      ...
      statusType: "ontime",
      elevatorModel: ["OTIS-X", "OTIS-Y"],
      salesRep: "Ana Silva",
      imageUrl: mastonImagem,
    },
    {
      id: "002",
    ...
    },
    {
      ...
      status: "Dentro do prazo",
      statusType: "ontime",
      elevatorModel: ["OTIS-Z", "OTIS-X", "OTIS-Y"],
      salesRep: "Fernanda Lima",
      imageUrl: elevatorImage,
    },
    {
      id: "016",
      company: "Centro Empresarial",
      location: "Curitiba, PR",
      lastUpdate: "23/07/2024",
      status: "Fora do prazo",
      statusType: "late",
      elevatorModel: ["OTIS-X"],
  ...
  obraCivil: [
    {
      id: "003",
      company: "Construtora Build",
      location: "Belo Horizonte, MG",
      lastUpdate: "15/07/2024",
      status: "Fora do prazo",
      statusType: "late",
      elevatorModel: ["OTIS-Z"],
      salesRep: "Juliana Costa",
      imageUrl: elevatorImage,
    },
    {
      id: "008",
      company: "Horizonte Eng.",
      location: "Salvador, BA",
      lastUpdate: "19/07/2024",
      status: "Dentro do prazo",
      statusType: "ontime",
      elevatorModel: ["OTIS-X"],
      salesRep: "Lucas Martins",
      imageUrl: elevatorImage,
    },
    {
      id: "011",
      company: "Vertical Towers",
      location: "Fortaleza, CE",
      lastUpdate: "14/07/2024",
      status: "Alerta de prazo",
      statusType: "alerta",
      elevatorModel: ["OTIS-Y"],
      salesRep: "Beatriz Souza",
      imageUrl: elevatorImage,
    },
    {
      id: "018",
      company: "Solidez Construtora",
      location: "Goiânia, GO",
      lastUpdate: "20/07/2024",
      status: "Dentro do prazo",
      statusType: "ontime",
      elevatorModel: ["OTIS-Z"],
      salesRep: "Ricardo Nunes",
      imageUrl: elevatorImage,
    },
    {
      id: "019",
      company: "Praça das Fontes",
      location: "Recife, PE",
      lastUpdate: "18/07/2024",
      status: "Dentro do prazo",
      statusType: "ontime",
  ...
  fabricacao: [
    ...
    {
      id: "012",
      company: "Mega Construtora",
      location: "Manaus, AM",
      lastUpdate: "23/07/2024",
      status: "Dentro do prazo",
      statusType: "ontime",
      elevatorModel: ["OTIS-Z"],
      salesRep: "Tiago Pereira",
      imageUrl: elevatorImage,
    },
    {
      id: "020",
  ...
  testesFinais: [
    ...
    {
      id: "029",
      company: "Hospital Inova",
      location: "Curitiba, PR",
      lastUpdate: "24/07/2024",
      status: "Dentro do prazo",
      statusType: "ontime",
      elevatorModel: ["OTIS-MED"],
      salesRep: "Fernanda Lima",
      imageUrl: elevatorImage,
    },
    {
