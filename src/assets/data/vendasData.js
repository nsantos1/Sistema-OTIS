...
export const vendasData = {
  ...
  contratos: [
    ...
    },
    {
      ...
      responsavel: { nome: "Carlos Mendes", inicial: "C" },
      imagemUrl:
        "https://images.pexels.com/photos/220769/pexels-photo-220769.jpeg?auto=compress&cs=tinysrgb&w=400",
    },
    {
      id: "#CT-0924",
      status: "Dentro do prazo",
      ...
      responsavel: { nome: "Fernanda Lima", inicial: "F" },
      imagemUrl:
        "https://images.pexels.com/photos/2440134/pexels-photo-2440134.jpeg?auto=compress&cs=tinysrgb&w=400",
    },
    {
      id: "#CT-0925",
      status: "Dentro do prazo",
  ...
  clientes: [
    ...
    },
    {
      ...
      local: "Brasília/DF",
      stats: [
        { icon: FaShoppingCart, valor: "30", label: "Pedidos" },
        { icon: FaHardHat, valor: "25", label: "Instalações" },
        { icon: FaUsers, valor: "18", label: "Contratos" },
      ],
    },
  ],
};