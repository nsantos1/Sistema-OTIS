...
export default function Slider({
  ...
  const prev = () => {
    setIndex((prev) => (prev > 0 ? prev - 1 : totalPages - 1));
  };

  const next = () => {
    setIndex((prev) => (prev < totalPages - 1 ? prev + 1 : 0));
  };
  ...
  const displayedSlides = isViewingAll
    ? slides
    : slides.slice(index * itemsPerPage, (index + 1) * itemsPerPage);
  ...
  return (
    <>
      ...
      <div className={`principal ${isViewingAll ? "grid-view" : ""}`}>
        {!isViewingAll && slides.length > itemsPerPage && (
          <button className="prev" onClick={prev}>
            ...
            >
              <path
                d="M6.5 13L16.0833 22.5833L13.1667 25.5L0.666672 13L13.1667 0.500001L16.0833 3.41667L6.5 13Z"
                fill="#0A2344"
              />
            </svg>
          </button>
        ...
        {!isViewingAll && slides.length > itemsPerPage && (
          <button className="next" onClick={next}>
            ...
            >
              <path
                d="M10.5 13L0.916647 3.41667L3.83331 0.5L16.3333 13L3.83331 25.5L0.916647 22.5833L10.5 13Z"
                fill="#0A2344"
              />
            </svg>
          </button>
