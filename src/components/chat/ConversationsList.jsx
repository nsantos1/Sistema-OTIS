...
function ConversationsList({ conversations, activeConversationId, onConversationClick }) {
  ...
  const filteredConversations = conversations
    ...
    .filter(convo => {
      ...
      return convo.participant.name.toLowerCase().includes(searchQuery.toLowerCase());
    });
